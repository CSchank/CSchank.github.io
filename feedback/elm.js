...
var $author$project$Main$fillTemplate = F2(
	function (keepGoing, model) {
		var replaceStudentName = A2(
			$elm$core$Basics$composeR,
			A2($elm$core$String$replace, '<Student>', model.studentName),
			A2($elm$core$String$replace, '<student>', model.studentName));
		var replaceStudentLearned = function () {
			if (keepGoing) {
				var learnedTxt = A3($author$project$Main$fillTemplate, false, model, model.studentLearned);
				return A2(
					$elm$core$Basics$composeR,
					A2($elm$core$String$replace, '<StudentLearned>', learnedTxt),
					A2($elm$core$String$replace, '<studentlearned>', learnedTxt));
			} else {
				return $elm$core$Basics$identity;
			}
		}();
		var replaceStudentDidWell = function () {
			if (keepGoing) {
				var didWellTxt = A3($author$project$Main$fillTemplate, false, model, model.studentDidWell);
				return A2(
					$elm$core$Basics$composeR,
					A2($elm$core$String$replace, '<StudentDidWell>', didWellTxt),
					A2($elm$core$String$replace, '<studentdidwell>', didWellTxt));
			} else {
				return $elm$core$Basics$identity;
			}
		}();
		var replaceParentName = A2(
			$elm$core$Basics$composeR,
			A2($elm$core$String$replace, '<Parent>', model.parentName),
			A2($elm$core$String$replace, '<parent>', model.parentName));
		var replaceNextSteps = function () {
			if (keepGoing) {
				var nextStepTxt = A3($author$project$Main$fillTemplate, false, model, model.nextSteps);
				return A2(
					$elm$core$Basics$composeR,
					A2($elm$core$String$replace, '<Nextsteps>', nextStepTxt),
					A2($elm$core$String$replace, '<nextsteps>', nextStepTxt));
			} else {
				return $elm$core$Basics$identity;
			}
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Generated email')
							])),
						A2($elm$html$Html$hr, _List_Nil, _List_Nil),
						$author$project$Main$renderEmail(model)
					]))
			]),
